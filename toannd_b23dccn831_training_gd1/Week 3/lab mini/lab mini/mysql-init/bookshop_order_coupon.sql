...
CREATE TABLE `order_coupon` (
  ...
  KEY `FKq3js7b06q3wv3vrh4ychepho8` (`order_id`),
  KEY `FK1u6nmrh6km00p20o421t999t7` (`coupon_id`),
  CONSTRAINT `FK1u6nmrh6km00p20o421t999t7` FOREIGN KEY (`coupon_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `FKq3js7b06q3wv3vrh4ychepho8` FOREIGN KEY (`order_id`) REFERENCES `coupons` (`id`)
